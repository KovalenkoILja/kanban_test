...
import 'package:kanban_test/authentication/data/models/password.dart';
import 'package:kanban_test/authentication/data/models/username.dart';
    ...
    if (state.status.isValidated) {
      ...
      try {
        ...
        yield state.copyWith(
            status: FormzStatus.submissionFailure, error: err.message);
      }
    }
  }
}
